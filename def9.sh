...
#
# wget -qO- https://raw.githubusercontent.com/Zer0CooL4ek/etc/main/def9.sh | bash
#
...
configure_ufw() {
    ...
    # Remove old SSH port rule if exists
...
main() {
    ...
    # Force interactive input even when using wget | bash
